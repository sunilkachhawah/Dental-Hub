...
public class reschedule  extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
...
//    Button occupybtn;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        inputtime = (Spinner) findViewById(R.id.spinner3);
        ...
        inputdate = (TextView) findViewById(R.id.appoin_date2);
        btndatepicker = (ImageButton) findViewById(R.id.apoin_date_calender2);
...
*/
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        TextView text99 = (TextView) parent.getChildAt(0);
        textView.setTextColor(getResources().getColor(R.color.colorPrimaryDark));
        ...
        String st1 = String.valueOf(sp3.getSelectedItem());
    ...
    private void book() {
        ...
        if (TextUtils.isEmpty(name)) {
            ...
            if (!(isValidPhone(phno))) {
                ...
                loadingBar.show();
                Toast.makeText(reschedule.this, " Your slot has been Rescheduled successfully ", Toast.LENGTH_SHORT).show();
                loadingBar.dismiss();
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(reschedule.this, " Your slot has been Booked successfully ", Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();

                                        Intent intent = new Intent(reschedule.this, Home_NavigationActivity.class);
                                        startActivity(intent);
                                        finish();
                                        notifications();

                                    } else {
                                        Toast.makeText(reschedule.this, "Network Error ! Please try again ", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });

                } else {
                    Toast.makeText(reschedule.this, "Slot already booked , Check for availabilty ", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                }
